...
export default function CandidateProfilePage({ params }) {
  ...
  const getMockCandidate = (id) => {
    ...
    const commonSummary = "Experienced web apps developer — Front-End with ReactJS & Redux, Back-End with Node.js and Django. Strong background in fintech and security platforms with proven track record of performance improvements.";
    ...
    const mockCandidates = {
      ...
      "2": {
        ...
        isVerified: false,
        experiences: commonExperiences,
        skills: ["Product Strategy", "User Research", "Data Analytics", "Agile", "UX Design"],
        highlights: commonHighlights,
        summary: commonSummary,
        aiMatch: 78
      }
            ...
            <div className="flex-1 p-8 max-w-4xl">
              ...
              <div className="mb-8">
                <div className="flex items-start gap-6">
                  {/* Avatar */}
                  <div className={`w-20 h-20 ${candidate.avatarColor || 'bg-blue-600'} rounded-full flex items-center justify-center text-white font-bold text-2xl`}>
                    {candidate.avatar}
                  </div>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="space-y-1 text-gray-600">
                      ...
                      <p className="text-lg font-semibold text-gray-900">{candidate.position}</p>
                      <p className="text-gray-600">{candidate.company}</p>
                      <p className="text-gray-600">{candidate.education} from {candidate.university}</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                {activeTab === "education" && (
                  <div className="space-y-4">
                    <div className="border-l-2 border-gray-200 pl-6">
                      <h3 className="text-lg font-semibold text-gray-900">{candidate.education || "Education Not Specified"}</h3>
                      <p className="text-gray-600">{candidate.university || "University Not Specified"}</p>
                    </div>
                  </div>
                )}
              ...
              <div className="mt-8">
                ...
                <p className="text-gray-700 leading-relaxed">{candidate.summary || "No summary available"}</p>
              </div>
            </div>
            ...
            <div className="w-80 bg-gray-50 p-6 border-l border-gray-200">
              ...
              <div className="mb-8">
                <div className="flex items-center justify-between mb-4">
                  <span className="text-sm text-gray-600">Profile 1 of 3000</span>
              ...
              <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
                ...
                <p className="text-sm text-gray-800">
                  This candidate matches {candidate.aiMatch || 85}% of your criteria based on previous approvals.
                </p>
              </div>
            </div>
          </div>
